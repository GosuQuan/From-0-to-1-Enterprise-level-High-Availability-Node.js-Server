...
class ChaosController {
  async init() {
    ...
    router.get('/promise-error-throw-with-catch',this.getPromiseErrorWithCatch)
    return router;
  }
  ...
  getPromiseErrorWithCatch = cc(async (req,res,next) =>{
    await new Primise((r)=> setTimeout(r, ASYNC_MS))
